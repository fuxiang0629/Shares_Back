...
class UpdateQuestionForm extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleValidateFrom = (values) => {
    ...
    this.props.handleUpdate({ ...values, Answer: this.state.content });
  };
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      editorState: BraftEditor.createEditorState(Answer),
      content:Answer
    });
  }
